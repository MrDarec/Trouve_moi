      ...
      <nav className="glass-navbar sticky top-0 z-50 px-4">
        <div className="max-w-7xl mx-auto h-16 flex items-center justify-between gap-4">
          ...
          <Link to="/" className="flex items-center gap-2.5 shrink-0 group">
            <div className="w-9 h-9 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-primary-400 group-hover:border-primary-500/50 group-hover:text-primary-300 transition-all shadow-sm">
              <Search size={18} />
            </div>
            <span className="font-bold text-lg text-slate-100 tracking-tight hidden sm:block">
              Trouve<span className="text-primary-400">Moi</span>
            </span>
          </Link>
            ...
            {[
              ...
              <Link
                ...
                className={`flex flex-col items-center gap-1 px-3 py-1 rounded-xl transition-all ${
                  highlight
                    ? 'bg-primary-600 text-white -mt-4 px-4 py-3 shadow-lg shadow-black/40 rounded-2xl'
                    : isActive(to)
                    ? 'text-primary-400'
                    : 'text-slate-500'
                }`}
